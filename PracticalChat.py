...
#         text = importtingFile()
#         file_content = f"this is the content of the file there will be quesitons asked from this file {text}"
#         print(text)
#         prompting = ""
#         prompting = f""" analyze this file text {text} and there will be questions from this file and answer only the answer from this file and don't overwrite about the question
#         Here's the question {prompt}"""

#         full_prompt = f"{file_content} {prompting}"
#         current_doc = text

#     combined = f"{history}{current_doc}{full_prompt}"
#     data = {
#         "contents" :[
#             {
